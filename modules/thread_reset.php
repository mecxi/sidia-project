 ...
 * @thread_retry : 15m
*/
$start_thread = thread_ctrl::run(null, null, 'crontab -l | grep -v "set_reset.php" | crontab - && (crontab -l ; echo "*/1 * * * * /usr/bin/php '.PROJECT_DIR.'/modules/set_run.php") | crontab - && echo done');
